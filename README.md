...
|------------------------------------------------------------------------------------------------------------| --- | --- |
| [Jaeger-v1.68.0-kunpeng](https://github.com/HuaweiCloudDeveloper/jaeger-image/tree/Jaeger-v1.68.0-kunpeng) | Installed and deployed based on Kunpeng servers + Huawei Cloud EulerOS 2.0 64-bit |  |
